  ...
  return (
    <div className='w-full min-h-screen bg-linear-to-b from-green-50 to-white'>
      <div className='max-w-2xl mx-auto pb-24'>
        <div className='sticky top-0 bg-white/80 backdrop-blur-xl p-4 border-b shadow
        flex gap-3 items-center z-999'>
...
<div className='bg-white rounded-3xl shadow-lg border p-4 h-[430px] flex flex-col'>
  <div className='flex justify-between items-center mb-3'>
              ...
              shadow-full shadow-sm border border-purple-200 cursor-pointer' 
          ...
          <div className='flex gap-2 flex-wrap mb-3'>
              {suggestions.map((s,i)=>(
                  ...
                  key={s}
                  whileTap={{scale:0.93}}
                  className='px-3 py-1 text-xs bg-green-50 border-green-200 cursor-pointer text-green-700 rounded-full'
  ...
  >
     ...
     <div className='flex gap-2 mt-3 border-t pt-3'>
        <input type="text" placeholder='Type Message...' className='flex-1 bg-gray-100 px-4 py-2 rounded-xl outline-none focus:ring-2
        focus:ring-green-500 'value={newMessage} onChange={(e)=>setNewMessage(e.target.value)} />
