...
import { ArrowLeft, ArrowLeftCircle, Package, PackageSearch } from 'lucide-react'
...
useEffect(()=>{
  ...
  return (
    <div className='bg-linear-to-b form-white to-gray-100 min-h-screen w-full'>
...
<button className='p-2 bg-gray-100 rounded-full hover:bg-gray-200 active:scale-95 transition'>
  <ArrowLeft size={24} className='text-green-700' onClick={()=>router.push("/")}/>
</button>
