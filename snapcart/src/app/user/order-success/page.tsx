...
function OrderSuccess() {
  return (
    ...
    px-6 text-center bg-linear-to-b from-green-50 to-white'>
        <motion.div
        ...
        transition={{
            ...
            >
                <div className='w-full h-full rounded-full bg-green-750 blur-2xl'/>
            </motion.div>
        </motion.div>
    <motion.h1 
    ...
    >Thank you for shopping with us! Your order has been placed and is being
        processes. You can track its progress in your <span className='font-semibold text-green-700'>My Orders </span>section.
    </motion.p>
    <motion.div
    ...
    >
        ...
        whileTap={{scale:0.93}}
        className='flex gp-2 items-center bg-green-600 hover:bg-green-700 text-white text-base font-semibold px-8 py-3 rounded-full shadow-lg transition-all '>
