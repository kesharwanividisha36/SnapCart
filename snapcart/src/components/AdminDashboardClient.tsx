...
function AdminDashboardClient({earning, stats ,chartData}:propType) {
  ...
  return (
    <div className='pt-28 w-[90%] m:w-[80%] mx-auto'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between 
        gap-4 mb-10 text-center sm:text-left'>
            <motion.h1
            ...
            focus:ring-2 focus:ring-green-500 outline-none transition w-full sm:w-auto'
        ...
        className='bg-green-50 border border-green-200 shadow-sm rounded-2xl
        p-6 text-center mb-10'
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10'>
            {stats.map((s,i)=>{
                ...
                rounded-2xl p-5 flex items-center gap-4 hover:shadow-lg transition-all'
                >
