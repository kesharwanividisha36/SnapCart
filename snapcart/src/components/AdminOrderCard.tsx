...
import { ChevronDown, ChevronUp, CreditCard, MapPin, Package, Package2, Phone, Truck, User, UserCheck } from 'lucide-react'
...
function AdminOrderCard({order}:{order:IOrder}) {
  ...
  return (
    ...
    className='bg-white shadow-md hover:shadow-lg border-gray-100 rounded-2xl p-6 transition-all '>
...
<div className='mt-3 space-y-1 to-gray-700 text-sm'>
...
<p className='mt-3 flex items-center gap-2 text-sm to-gray-700'>
