...
function HeroSection() {
    ...
    const slides=[
        ...
        },
        {
          ...
          subtitle:"We ensure your groceries reach your doorstep in notime",
          btnText:"Order Now",  
          bg:"https://images.unsplash.com/photo-1647069384985-c6a473d6d628?q=80&w=1193&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...
/>
<div className='absolute inset-0 bg-black/50 backrdop-blur-[1px]'/>
     </motion.div>
    </AnimatePresence>
    ...
    className='mt-4 bg-white text-green-700 hover:bg-green-100 px-8 py-3 rounded-full font-semibold shadow-lg transition-all
