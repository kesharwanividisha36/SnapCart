...
<div  className='relative w-full aspect-4/3 bg-gray-50 overflow-hidden group'>
    <Image src={item.image} fill alt={item.name} sizes='(mx-width:768px) 100vw,25vw'
...
{!cartItem ?<motion.button className='mt-4 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white rounded-full py-2.5 px-4 text-sm font-medium transition-all '
    whileTap={{scale:0.96}}
    ...
    className='mt-4 flex items-center justify-center bg-green-50 border border-green-200 rounded-full py-4 px-4 gap-4'
    >
