...
function Welcome({nextStep}:propType) {
  ...
  return (
    <div className='flex flex-col items-center justify-center
     min-h-screen text-center p-6 bg-linear-to-b from-green-0 to-white'>
        <motion.div
        initial={{
        opacity:0,
        y:-20
       ...
       <h1 className='text-4xl md:text:5xl font-extrabold text-green-700'>SnapCart</h1>
        ...
        >
          Welcome! Get the freshest groceries delivered to your doorstep, making everyday shopping simple and convenient.
        </motion.p>
        <motion.div
        initial={{
        opacity:0,
        ...
        className='inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold
         py-3 px-8 rounded-2xl shadow-md transition-all duration-200 mt-10'onClick={()=>nextStep(2)}
        >
Next
<ArrowRight/>
        </motion.button>
